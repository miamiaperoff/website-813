...
const Hero = () => {
  ...
  return (
    <section id="home" className="relative min-h-[70vh] md:min-h-screen flex flex-col items-center justify-end overflow-hidden">
      {/* Background image */}
      ...
      <div className="relative z-10 text-center px-6 mt-[30px] max-w-5xl mx-auto bg-primary/80 md:bg-transparent py-8 md:py-0">
        <p className="font-serif text-3xl md:text-7xl lg:text-9xl text-primary-foreground font-light italic leading-none md:leading-none animate-fade-in" style={{ animationDelay: '0.2s' }}>
